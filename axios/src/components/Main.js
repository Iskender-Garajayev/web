    ...
    <div className='main_card_img'>
      <div className=' w-full grid grid-cols-3 h-full items-center justify-center pt-32  flex-wrap '>
        {pizzaData && pizzaData.map(n=>(
          <div key={n.id} className="drop-shadow-lg md lg:w-100 min-w-[150px]  p-4 bg-cardOverlay backdrop-blur-md rounded-3xl flex flex-col items-center justify-center">
