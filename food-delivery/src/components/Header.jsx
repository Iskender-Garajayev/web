      ...
      <div className='hidden md:flex w-full h-full items-center justify-between'>
        ...
        <div className='flex items-center gap-8'>
          ...
          <div className=' relative'>
            ...
            {
              isMenu && (
                <motion.div initial={{opacity : 0, scale : 0.6}}  animate={{opacity : 1, scale : 1}} exit={{opacity : 0, scale : 0.6}} className=' w-40 bg-green-50 shadow-xl rounded-lg flex flex-col absolute top-12 right-0'>
              {
